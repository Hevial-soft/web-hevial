...
export function Footer() {
  return (
    <footer className="bg-white border-t border-black/[0.07] pt-10 pb-8 px-5 sm:px-8 md:px-14">
      {/* Top row */}
      <div className="w-full flex flex-col sm:flex-row items-start sm:items-end justify-between gap-6">
        ...
        <div className="flex flex-col items-start sm:items-end gap-2">
          ...
          <div className="text-[8px] font-semibold tracking-[2px] text-[#666] uppercase">
            @HevialPrintBot
          </div>
        </div>
      </div>
      ...
      {/* Bottom row */}
      <div className="w-full mt-8 pt-5 border-t border-black/[0.06] flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        <Logo size="sm" />

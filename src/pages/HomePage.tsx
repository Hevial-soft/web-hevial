...
const services = [
  {
    icon: (<svg width="20" height="20" viewBox="0 0 24 24" stroke="white" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="12 2 2 7 12 12 22 7 12 2" /><polyline points="2 17 12 22 22 17" /><polyline points="2 12 12 17 22 12" /></svg>),
    title: '3D-печать', desc: 'FDM, SLA и SLS печать любых деталей. PLA, PETG, ABS, нейлон и смолы.',
  },
  {
    icon: (<svg width="20" height="20" viewBox="0 0 24 24" stroke="white" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8" /><line x1="21" y1="21" x2="16.65" y2="16.65" /></svg>),
    title: 'Реверс-инжиниринг', desc: 'Снимаем размеры с готовых деталей и создаём точные 3D-модели.',
  },
  {
    icon: (<svg width="20" height="20" viewBox="0 0 24 24" stroke="white" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2" /><line x1="3" y1="9" x2="21" y2="9" /><line x1="9" y1="21" x2="9" y2="9" /></svg>),
    title: '3D-моделирование', desc: 'Разрабатываем модели с нуля по эскизам, чертежам или описанию.',
  },
  {
    icon: (<svg width="20" height="20" viewBox="0 0 24 24" stroke="white" fill="none" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="1" y="3" width="15" height="13" /><polygon points="16 8 20 8 23 11 23 16 16 16 16 8" /><circle cx="5.5" cy="18.5" r="2.5" /><circle cx="18.5" cy="18.5" r="2.5" /></svg>),
    title: 'Доставка', desc: 'Курьер по Москве, СДЭК по всей России или самовывоз — на ваш выбор.',
  },
]
...
export function HomePage() {
  ...
  return (
    <div ref={pageRef} className="bg-white text-[#080808] overflow-x-hidden">
      ...
      {/* ── HERO ── */}
      <section id="services" className="min-h-screen flex items-center pt-[90px] md:pt-[120px] pb-16 md:pb-20 bg-white relative overflow-hidden">
        ...
        <Container className="grid grid-cols-1 md:grid-cols-[1.1fr_0.9fr] gap-10 md:gap-[60px] items-center">
          <div>
            <div className="text-[10px] font-bold tracking-[5px] text-[#1400FF] uppercase mb-5 md:mb-6 animate-fadeUp-1">Студия 3D-печати</div>
            <h1 className="font-garet font-extrabold leading-[1.06] tracking-[-1.5px] text-[#080808] mb-6 md:mb-7 animate-fadeUp-2"
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-3.5 animate-fadeUp-4">
              <a href="https://t.me/HevialPrintBot" target="_blank" rel="noopener noreferrer"
                ...
                <TelegramIcon size={16} />Оформить заказ
              </a>
              <a href="#about"
            ...
            <div className="grid grid-cols-2 gap-px bg-[#1400FF]/10 border border-[#1400FF]/10">
              {services.map((srv) => (
                <div key={srv.title} className="bg-white p-5 md:p-7 transition-colors duration-200 hover:bg-[#F4F5F9]">
                  <div className="w-[34px] h-[34px] md:w-[38px] md:h-[38px] bg-[#1400FF] flex items-center justify-center mb-3">{srv.icon}</div>
      ...
      {/* ── ABOUT ── */}
      <section id="about" className="py-16 md:py-24 relative overflow-hidden" style={{ background: '#1400FF' }}>
        <div className="absolute right-[-40px] bottom-[-20px] font-garet font-extrabold pointer-events-none select-none leading-none tracking-[-6px]"
          style={{ fontSize: 'clamp(80px, 18vw, 200px)', color: 'rgba(255,255,255,0.04)' }}>HEVIAL</div>
        <Container>
          <div className="reveal grid grid-cols-1 md:grid-cols-[1fr_2fr] gap-8 md:gap-[60px] items-start mb-10 md:mb-14 pb-8 md:pb-11 border-b border-white/15">
            <div>
              ...
              <h2 className="font-garet font-extrabold text-white leading-[1.1] tracking-[-1px]" style={{ fontSize: 'clamp(22px, 4vw, 38px)' }}>
      ...
      <section id="contacts" className="py-14 md:py-20 bg-[#F4F5F9] border-t border-black/[0.06]">
        <Container>
          <h2 className="font-garet text-lg md:text-[20px] font-bold text-[#080808] mb-7 md:mb-9">Где можно с нами связаться?</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-3.5 sm:max-w-[540px]">
            <a href="mailto:info@hevial.ru"
